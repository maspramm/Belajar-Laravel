                    ...
                    <div class="card-body">
                        <form action="<?php echo e(route('posts.store')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control <?php $__errorArgs = ['foto_mahasiswa'];
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <?php $__errorArgs = ['foto_mahasiswa'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" name="nim"
                                    value="<?php echo e(old('nim')); ?>" placeholder="Masukkan NIM Mahasiswa">
...
unset($__errorArgs, $__bag); ?>"
                                    name="nama_mahasiswa" value="<?php echo e(old('nama_mahasiswa')); ?>"
...
</html><?php /**PATH C:\laragon\www\mahasiswa\resources\views/posts/create.blade.php ENDPATH**/ ?>